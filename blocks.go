...
/**
uncompressedPng writes out a png without any compression
*/
func uncompressedPng(w io.Writer, m image.Image) error {
	var e png.Encoder
...
func imageToBitmap(src image.Image) (image.Image, error) {
